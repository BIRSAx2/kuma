//! AArch64 register definitions and targets.

use crate::ir::internal::{Architecture, Target};
...
/// ELF ARM64 target.
pub static T_AARCH64_ELF: Target = Target {
...
pub static T_AARCH64_APPLE: Target = Target {
    architecture: Architecture::Aarch64,
    apple: true,
    gpr0: R0 as i32,
    ngpr: NGPR,
